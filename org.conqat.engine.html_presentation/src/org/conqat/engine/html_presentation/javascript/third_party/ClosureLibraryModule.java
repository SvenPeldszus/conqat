 ...
 * @version $Rev: 47373 $
 * @ConQAT.Rating GREEN Hash: 324D66EF5917158164544A438B207800
 */
public class ClosureLibraryModule extends JavaScriptModuleBase {
	...
	protected void createJavaScriptFiles() throws ConQATException {
		...
		String soyutilsScript = loadScript(soyutilsName);

		// we patch the Soy utils here to allow the use of sanitized types (e.g.
		// SanitizedHtml)
		soyutilsScript = soyutilsScript.replaceAll(
				"goog.soy.data.SanitizedContent.call\\(this\\);",
				"this.content = arguments[0];");

		addJavaScriptFile(createJavaScriptFileForClosure(EType.CODE_LIBRARY,
				soyutilsName, soyutilsScript,
