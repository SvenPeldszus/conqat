 ...
 * @version $Rev: 47368 $
 * @ConQAT.Rating GREEN Hash: 79A866FE48CF3899C81C843F492BDE72
 */
...
/**
 * Static method for installing the goto box script. This enables an
 * auto-completion menu on the goto box.
 * 
 * @param {string} textId the id of the main navigation tree.
 * @param {string} buttonId id of the expand all button.
 * @param {!Array.<string>} cssClasses the CSS classes to be used (render, row,
 *            active, highlighted)
 * @param {!Object.<string, string>} links mapping from strings to linked URLs
 */
conqat.base.GotoBox.install = function(textId, buttonId, cssClasses, links) {
	...
	var autocomplete = goog.ui.ac.createSimpleAutoComplete(data, textElement,
			false, true);
