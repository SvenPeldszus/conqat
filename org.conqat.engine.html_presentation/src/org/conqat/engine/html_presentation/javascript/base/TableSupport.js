 ...
 * @version $Rev: 51466 $
 * @ConQAT.Rating YELLOW Hash: BC2D8C70CB7B50291587B1A80EA9568F
 */
 ...
 * 
 * Tries to detect numbers and dates. Dates are any numeric values separated by the usual
 * date separators and are assumed to be in ascending specificity (e.g. yyyy-MM-dd hh:mm:ss).
 * Numbers are everything else that starts with a digit.
 * 
 * @param {*} a
 * @param {*} b
...
conqat.base.TableSupport.installDrilldownRowCss = function() {
	...
	// Google closure sometimes sets both attributes for leaf nodes. In this case, we want to hide the collapse/expand button
	goog.cssom
			.addCssText("tr.goog-drilldown-collapsed.goog-drilldown-expanded .toggle { background-image: none; }");
};
