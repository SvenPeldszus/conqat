 ...
 * @version $Rev: 49870 $
 * @ConQAT.Rating GREEN Hash: 09FFA356BDB45D80FD0EB42B07D63EE4
 */
public class SimulinkBlockParameterAssessorTest extends SimulinkTestCaseBase {
	...
	public void testDefinedTypeDenyEverything() throws ConQATException {
		assessor.addRule("DefinedTypeDenyEverything", NONE,
				ALLOW_EVERYTHING_PATTERN, false, "Sum", "IconShape", "round",
	...
	public void testDefinedType() throws ConQATException {
		assessor.addRule("DefinedType", NONE, ALLOW_EVERYTHING_PATTERN, false,
				"Sum", "ForegroundColor", "bl.*", "blue");
	...
	public void testDefinedTypeAllowEverything() throws ConQATException {
		assessor.addRule("DefinedTypeAllowEverything", NONE,
				ALLOW_EVERYTHING_PATTERN, false, "Sum", "ForegroundColor",
				ALLOW_EVERYTHING_PATTERN, "yellow");
	...
	public void testAllBlocksDenyEverything() throws ConQATException {
		assessor.addRule("AllBlocksDenyEverything", NONE,
				ALLOW_EVERYTHING_PATTERN, false, ALL_BLOCKS_TYPE, "DropShadow",
				"off", DENY_EVERYTHING_PATTERN);
	...
	public void testAllBlocks() throws ConQATException {
		assessor.addRule("AllBlocks", NONE, ALLOW_EVERYTHING_PATTERN, false,
	...
	public void testAllBlocksAllowEverything() throws ConQATException {
		assessor.addRule("AllBlocksAllowEverything", NONE,
				ALLOW_EVERYTHING_PATTERN, false, ALL_BLOCKS_TYPE,
