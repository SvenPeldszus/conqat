 ...
 * @version $Rev: 51473 $
 * @ConQAT.Rating GREEN Hash: E204E2131039F0D1F07E39DF485E46ED
 */
public class SimulinkInPort extends SimulinkPortBase {
	...
	/* package */void setLine(SimulinkLine line)
		...
		CCSMPre.isTrue(line.getDstPort() == this, "Line's port does not match.");
		this.line = line;
	}
	...
	public boolean isSpecialPort() {
		return isEnablePort() || isTriggerPort();
	}
}