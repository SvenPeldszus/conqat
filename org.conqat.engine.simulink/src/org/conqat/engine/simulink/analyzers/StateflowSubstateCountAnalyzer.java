 ...
 * @version $Rev: 48957 $
 * @ConQAT.Rating GREEN Hash: 2972E5F8ACC624A3B291235B2D1BAEAD
 */
...
public class StateflowSubstateCountAnalyzer extends
	...
	public static final String SUBSTATE_COUNT_DISTRIBUTION_KEY = "Substate Count Distribution";

	/** {@ConQAT.Doc} */
	@AConQATKey(description = "Max Substate Count", type = "java.lang.Integer")
	public static final String MAX_SUBSTATE_COUNT_KEY = "Max Substate Count";
