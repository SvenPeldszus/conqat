 ...
 * @version $Rev: 49763 $
 * @ConQAT.Rating GREEN Hash: F9C9A945074D26A9CBAFF7384DC29BFA
 */
...
public class EmptyInterfaceCommentAnalysis extends CommentFindingAnalysisBase {
	...
	public static final String FINDING_GROUP_NAME = "Empty Interface Comment";
	...
	protected void analyzeComment(IElement element, Comment comment,
		...
		if (category == ECommentCategory.INTERFACE) {
			if (CommentUtils.hasOnlyJavaDoc(comment.getText())) {
