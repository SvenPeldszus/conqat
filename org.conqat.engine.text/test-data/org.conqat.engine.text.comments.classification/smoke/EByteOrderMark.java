 ...
 * @version $Rev: 49638 $
 * @ConQAT.Rating GREEN Hash: 7F92ACFE65653850E42DEAA6712E9571
 */
public enum EByteOrderMark {

	/** UTF-32 with big endian encoding. §interface§ */
	UTF_32BE("UTF-32BE", new byte[] { 0x00, 0x00, (byte) 0xFE, (byte) 0xFF }),

	/** UTF-32 with little endian encoding. §interface§  */
	UTF_32LE("UTF-32LE", new byte[] { (byte) 0xFF, (byte) 0xFE, 0x00, 0x00 }),

	/** UTF-16 with big endian encoding. §interface§ */
	UTF_16BE("UTF-16BE", new byte[] { (byte) 0xFE, (byte) 0xFF }),

	/** UTF-16 with little endian encoding. §interface§ */
	...
	/** The maximal length of a BOM. §interface§ */
	public static final int MAX_BOM_LENGTH = 4;

	/** The name of the encoding §interface§ */
	private final String encoding;

	/** The byte order mark. §interface§ */
	...
	/** Returns the encoding. §interface§ */
	...
	/** Returns the size of the BOM in bytes.  §interface§ */
