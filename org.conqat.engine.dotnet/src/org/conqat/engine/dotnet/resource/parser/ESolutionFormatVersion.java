 ...
 * @author $Author: goeb $
 * @version $Rev: 51331 $
 * @ConQAT.Rating RED Hash: BB4CF91A86A689BF7F72EDBD8AE8B750
 */
public enum ESolutionFormatVersion {
	...
	// TODO (AG) Do we already know about 2013? I suppose it is the same (?)
	VERSION_9;
	...
	/** Major version that identifies VS 2010, 2008 projects. */
	private static final int TOOLS_VERSION_2010_2008 = 3;

	/** Major version that identifies VS 2012 projects. */
	private static final int TOOLS_VERSION_2012 = 4;

	/** Major version that identifies VS 2013 projects. */
	private static final int TOOLS_VERSION_2013 = 12;
	...
	public static ESolutionFormatVersion determineProjectFormat(
		...
		if (toolsVersionMatcher.find()) {
			...
			if (major == TOOLS_VERSION_2010_2008 || major == TOOLS_VERSION_2012
					|| major == TOOLS_VERSION_2013) {
				return ESolutionFormatVersion.VERSION_9;
			}
