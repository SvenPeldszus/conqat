 ...
 * @version $Rev: 50686 $
 * @ConQAT.Rating GREEN Hash: 5AF095F40F0F19AC54AF095E1B83507B
 */
public class GendarmeReportReaderTest extends NUnitReportReaderTestCaseBase {

	/**
	 * Reads 'gendarme.xml' and asserts the created findings are correct.
	 */
	public void testObtainingFindingReport() throws ConQATException {
		...
		checkGroupAvoidCallingProblematicMethodsRule(groups);
		checkGroupWriteStaticFieldFromInstanceMethodRule(groups);
	}

	/**
	 * Check group 'AvoidCallingProblematicMethodsRule'.
	 */
	private void checkGroupAvoidCallingProblematicMethodsRule(
			HashMap<String, FindingGroup> groups) throws ConQATException {
	 ...
	 */
	private void checkGroupWriteStaticFieldFromInstanceMethodRule(
			HashMap<String, FindingGroup> groups) throws ConQATException {
	...
	/**
	 * Simple smoke test. Just asserts that no exception is thrown.
	 */
	public void testParsingAsSmokeTest() throws Exception {
