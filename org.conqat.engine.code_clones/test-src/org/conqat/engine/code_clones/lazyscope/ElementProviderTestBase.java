 ...
 * @version $Rev: 50585 $
 * @ConQAT.Rating GREEN Hash: D84ABD1694A558AD25052ABE256C3E17
 */
public abstract class ElementProviderTestBase extends TokenTestCaseBase {
	...
	protected void setUp() throws ConQATException {
		root = createJavaResourceHierarchyFor(useTestFile(""));
	...
	public void testGetNextElement() {
		...
		for (ITextElement element : actualElements) {
			String nameOffset = StringUtils.stripPrefix(element.getLocation(),
					prefix);
