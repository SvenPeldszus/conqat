 ...
 * @version $Revision: 50765 $
 * @ConQAT.Rating GREEN Hash: 73FBCB571D7CB35903ED849E447CD25F
 */
public class TokenUnit extends Unit {
	 ...
	 * content.
	 */
	public TokenUnit(String content, int filteredStartOffset,
			int filteredEndOffset, String elementUniformPath,
			ETokenType tokenType, int indexInElement) {
		this(content, content, filteredStartOffset, filteredEndOffset,
