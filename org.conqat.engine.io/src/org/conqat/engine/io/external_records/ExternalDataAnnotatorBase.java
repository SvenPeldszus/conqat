 ...
 * @version $Rev: 51575 $
 * @ConQAT.Rating RED Hash: 2448E82DC81DBD921ACED7B7908DEF3E
 */
public abstract class ExternalDataAnnotatorBase<R extends IResource, E extends IElement, C extends Enum<C>>
	...
	/** {@ConQAT.Doc} */
	// TODO (FS) this is not my review, but I just noticed this and since the
	// file is RED, I'm leaving this for whoever added the <code> tags:
	// they won't work in the conqat doc view in eclipse. please remove.
	@AConQATFieldParameter(parameter = "log-on-missing", attribute = "value", optional = true, description = ""
			+ "If <code>true</code>, a message is logged (accorind to specified log level), if an element is without an matching entry "
			+ "in the external data. Default is <code>false</code>")
	public boolean logOnMissing = false;
	...
	/** {@ConQAT.Doc} */
	@AConQATFieldParameter(parameter = ConQATParamDoc.LOG_LEVEL_NAME, description = ConQATParamDoc.LOG_LEVEL_DESCRIPTION
			+ " Default is WARN.", attribute = ConQATParamDoc.ATTRIBUTE_VALUE_NAME, optional = true)
	public ELogLevel logLevel = ELogLevel.WARN;

	/** {@ConQAT.Doc} */
	// TODO (AG, issue #5714) Description ("whether") sounds like this was a
	// boolean flag. The logic as well as the parameter name suggest you should
	// update the doc. In addition, other processors name this parameter
	// "ignore" (with attribute "key") as opposed to "filter". Please check.
