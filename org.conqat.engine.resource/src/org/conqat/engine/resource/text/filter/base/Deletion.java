 ...
 * @version $Rev: 48467 $
 * @ConQAT.Rating GREEN Hash: 19697E619948AD599548A790259C1395
 */
public class Deletion implements Comparable<Deletion>, Serializable {
	...
	/**
	 * Returns whether the given location is completely covered by this
	 * deletion.
	 */
	public boolean covers(TextRegionLocation location) {
		return startOffset <= location.getRawStartOffset()
				&& location.getRawEndOffset() < endOffset;
	}
