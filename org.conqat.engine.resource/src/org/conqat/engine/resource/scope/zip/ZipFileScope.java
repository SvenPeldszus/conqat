 ...
 * @version $Rev: 50585 $
 * @ConQAT.Rating GREEN Hash: CF350E953DAF2BD564AE136BC415336C
 */
...
public class ZipFileScope extends PatternSupportingScopeBase {
	...
	private final List<IElement> zipFiles = new ArrayList<IElement>();

	/**
	 * The result list used for storing the created accessors. The processor
	 * returns this list as array.
	 */
	...
	public void addResource(
		...
		zipFiles.addAll(ResourceTraversalUtils.listElements(resource));
	}
	...
	private void processZipFile(CanonicalFile file) throws ConQATException {
		...
		for (String entry : entries) {
			...
			String relativeEntry = StringUtils.stripPrefix(entry, entryPrefix);
			relativeEntry = StringUtils.stripPrefix(relativeEntry,
