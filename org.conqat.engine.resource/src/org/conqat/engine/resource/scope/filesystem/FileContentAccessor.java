 ...
 * @version $Rev: 50585 $
 * @ConQAT.Rating GREEN Hash: E6CB99E329F959EB5E378CA362552450
 */
public class FileContentAccessor extends ContentAccessorBase {
	...
	protected static String obtainRelativePath(CanonicalFile file,
			CanonicalFile root) {
		String localPath = StringUtils.stripPrefix(file.getCanonicalPath(),
				root.getCanonicalPath());
		return StringUtils.stripPrefix(FileSystemUtils.normalizeSeparators(localPath),
	...
	/* package */String determineNewUniformPath(CanonicalFile newFile)
		...
		String fileSuffix = StringUtils.stripPrefix(filePath, pathPrefix);
		String uniformPrefix = StringUtils.stripSuffix(getUniformPath(),
				fileSuffix);
		...
		String newUniformPath = uniformPrefix
				+ StringUtils.stripPrefix(newFilePath, pathPrefix);
