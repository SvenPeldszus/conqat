 ...
 * @version $Rev: 49015 $
 * @ConQAT.Rating GREEN Hash: 86765E22CD8F6B3862B0590214F05D2D
 */
...
public class IgnoreAwareLOCAnalyzer extends
	...
	/** {@ConQAT.Doc} */
	@AConQATParameter(name = "ignore", description = "Determines whether elements and regions that are marked as ignored, "
			+ "e.g. because they are in genereated code, are ignored. Lines that are marked as ignore are stored under the key specified with "
			+ "'loc-ignore', the non ignored line count is stored unser the key specified with 'loc-valid'.", minOccurrences = 0, maxOccurrences = -1)
	public void addIgnoreKey(
	...
	/** Determines lines of code of the element. */
	@Override
