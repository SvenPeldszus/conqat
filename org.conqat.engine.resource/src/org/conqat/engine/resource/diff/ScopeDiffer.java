 ...
 * @version $Rev: 50735 $
 * @ConQAT.Rating YELLOW Hash: 43E8C410F64FE8EFA110526B17A9BAB4
 */
...
public class ScopeDiffer extends ScopeDifferBase {
	...
	/** {@ConQAT.Doc} */
	@AConQATFieldParameter(parameter = "max-delta", attribute = "size", optional = true, description = "Maximum size for delta calculation. Use this option to prevent memory overflow.")
	public int maxDeltaSize = Integer.MAX_VALUE;

	
	/** Collects uniform paths for logging new elements */
	private final Set<String> newElements = new HashSet<String>();

	/** Collects uniform paths for logging modified elements */
	private final Set<String> modifiedElements = new HashSet<String>();

	/** Collects uniform paths for logging unchanged elements */
	private final Set<String> unchangedElements = new HashSet<String>();

	/** Collects uniform paths for logging of removed elements */
	private final Set<String> removedElements = new HashSet<String>();
	...
	protected void determineDiff(ITextElement mainElement,
		...
		CodeChurnMetrics<ITextElement> codeChurnMetrics = new LocCodeChurnMetrics(
				mainElement, compareeElement, maxDeltaSize, getLogger());
