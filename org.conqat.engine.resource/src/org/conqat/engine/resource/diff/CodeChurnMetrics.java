 ...
 * @version $Rev: 50735 $
 * @ConQAT.Rating YELLOW Hash: 1D6C21203A9D9B688E333B2864983A3C
 * 
 * @param <T>
...
public abstract class CodeChurnMetrics<T extends ITextElement> {
	...
	protected void calculateMetrics(T mainElement, T compareeElement,
		...
		calculateMetrics(mainElement, compareeElement, Integer.MAX_VALUE,
				logger);
	}
	 ...
	 */
	protected void calculateMetrics(T mainElement, T compareeElement,
			int maxDeltaSize, IConQATLogger logger) throws ConQATException {
