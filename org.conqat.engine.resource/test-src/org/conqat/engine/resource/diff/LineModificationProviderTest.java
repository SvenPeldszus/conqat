...
import org.conqat.engine.resource.diff.LineModificationProvider;
...
/**
 * Test case for {@link LineModificationProvider}
 * 
 ...
 */
public class LineModificationProviderTest extends CCSMTestCaseBase {
	...
	private void assertInsertions(String word1, String word2,
		...
		List<Integer> actual = new LineModificationProvider(delta).getInsertions();
	...
	private void assertDeletions(String word1, String word2,
		...
		List<Integer> actual = new LineModificationProvider(delta).getDeletions();
