 ...
 * @version $Rev: 49408 $
 * @ConQAT.Rating GREEN Hash: 9D59838351DBCB9DDE90BBBC28AB16D0
 */
@AConQATProcessor(description = "desc")
public class ProcessorWithNonStringKey extends TestProcessorBase {

	/** test key that is no string. */
	@AConQATKey(type = "java.lang.String", description = "desc")
	public static final Object key = null;
