 ...
 * @version $Rev: 49408 $
 * @ConQAT.Rating GREEN Hash: D5217E29A468BC6FC98A93D82F4373FB
 */
@AConQATProcessor(description = "desc")
public class ProcessorWithNonFinalKey extends TestProcessorBase {

	/** test key that is no string. */
	@AConQATKey(type = "java.lang.String", description = "desc")
	public static String key = "keyName";
