 ...
 * @version $Rev: 49408 $
 * @ConQAT.Rating GREEN Hash: FC77ED59C3E8B71FEAD91F9426B00FAA
 */
@AConQATProcessor(description = "desc")
public class ProcessorWithParameterObjectWithoutInterface extends
		TestProcessorBase {
	...
	/** Parameter object that is missing the interface implementation. */
