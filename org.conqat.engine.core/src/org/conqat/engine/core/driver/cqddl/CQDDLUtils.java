 ...
 * @version $Rev: 50310 $
 * @ConQAT.Rating YELLOW Hash: D87D47E94308723C93DA1C77D5DBF19F
 */
public class CQDDLUtils {
	 ...
	 * @param logger
	 *            ConQAT logger that is used during execution for writing log
	 *            messages to.
	...
	public static Object executeProcessor(String processorClassName,
			IConQATLogger logger, CQDDLParsingParameters parsingParameters,
			Object... args) throws ConQATException, CQDDLExecutionException {
		...
		try {
			...
			processor.init(new ProcessorInfoMock(logger));
	 ...
	 * @param params
	 *            as described in
	 *            {@link #executeProcessor(String, ConQATLogger, CQDDLParsingParameters, Object...)}
	 */
	...
	private static void applyParameter(IConQATProcessor processor,
		...
		parameter.applyParameter(processor, attributeValues);
	}
