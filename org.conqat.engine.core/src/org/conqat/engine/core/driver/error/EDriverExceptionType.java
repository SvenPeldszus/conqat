 ...
 * @version $Rev: 49465 $
 * @ConQAT.Rating GREEN Hash: 405561A6378896E40AC336D1B4CD4346
 */
public enum EDriverExceptionType {
	...
	/** A non-public field or method was annotated. */
	...
	/**
	 * Parameter object class does not implement interface
	 * {@link IConQATParameterObject}.
	 */
	PARAMETER_OBJECT_CLASS_NOT_IMPLEMENTS_INTERFACE,

	/**
	 * Parameter object class is not public.
	 */
