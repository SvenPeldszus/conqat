 ...
 * @version $Rev: 49837 $
 * @ConQAT.Rating GREEN Hash: 380F3BF66C2C3FA96113E00F79C44F08
 */
public class BundleDescriptorReader extends
	...
	/** Filename of the XML bundle descriptor file */
	...
	protected BundleDescriptorReader(File file) throws IOException {
		super(file, new XMLResolver<EBundleXMLElement, EBundleXMLAttribute>(
	...
	/**
	 * Read core version requirement and check if the core satisfies the
	 * requirement.
	 * 
	 * @throws BundleException
	 *             if the core does not satisfy the requirement.
	 */
	...
	/** Base class for bundle element processors. */
	...
	/**
	 * Processor for dependencies ({@link EBundleXMLElement#dependsOn} element).
	 */
	private class DependenciesProcessor extends BundleInfoProcessorBase {
		 ...
		 * {@inheritDoc}
		 * 
		 * @return {@link EBundleXMLElement#dependsOn}.
		 */
		@Override
	...
	private class VersionProcessor implements
		...
		/** Process version and store it in {@link #version}. */
		@Override
		public void process() {
			int minor = getIntAttribute(EBundleXMLAttribute.minor);
			int major = getIntAttribute(EBundleXMLAttribute.major);
