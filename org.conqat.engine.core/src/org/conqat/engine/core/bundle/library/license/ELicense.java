 ...
 * @version $Rev: 47369 $
 * @ConQAT.Rating GREEN Hash: 83B5EF1D6FDBD4E5FDE0D6D6CD132A71
 */
public enum ELicense implements ILicense {
	...
	LGPL_v2("GNU Lesser General Public License Version 2.1", true, true,
			"http://www.gnu.org/copyleft/lesser.html", "LGPLv2"),

	/** GNU Lesser General Public License v3 */
	LGPL_v3("GNU Lesser General Public License Version 3", true, true,
	...
	CDDL_v1_1("Common Development and Distribution License 1.0", true, true,
			"http://opensource.org/licenses/CDDL-1.0", "CDDLv1"),
