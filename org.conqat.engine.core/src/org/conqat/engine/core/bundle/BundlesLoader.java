 ...
 * @version $Rev: 47364 $
 * @ConQAT.Rating GREEN Hash: CC94878B9C3B273396D134A6123E2431
 */
public class BundlesLoader {
	 ...
	 */
	public static void loadLibraryLocations(BundleInfo bundleInfo)
			throws BundleException {
	 ...
	 */
	private static void loadLibraryDescriptors(BundleInfo bundleInfo,
