 ...
 * @version $Rev: 50123 $
 * @ConQAT.Rating GREEN Hash: 77C6C324F23C2655748DF21A6F3A1A17
 */
public class ArchitectureDesignConstants {
	...
	/**
	 * Character used for separating long hierarchical names. This only has an
	 * effect for displaying, as typically only the last part is shown.
	 * Internally and for error messages, the full name is always used.
	 */
	public static final char ARCHITECTURE_NAME_SEPARATOR = '/';
