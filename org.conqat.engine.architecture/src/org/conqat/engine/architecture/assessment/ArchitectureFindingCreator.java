 ...
 * @version $Rev: 51068 $
 * @ConQAT.Rating GREEN Hash: FB06D9B4430C401BC0AD820F996746B8
 */
...
public class ArchitectureFindingCreator extends
	...
	/** The default key used for storing the findings (see also {@link #key}). */
	public static final String DEFAULT_FINDING_KEY = "findings";
	...
	public String key = DEFAULT_FINDING_KEY;
			...
			Finding finding = FindingUtils
					.createAndAttachFinding(
							...
							"Type depends on '"
									...
									+ "'. This violates the architecture specification in '"
									+ assessedArchitecture.getName() + "'",
							source, location, key);
