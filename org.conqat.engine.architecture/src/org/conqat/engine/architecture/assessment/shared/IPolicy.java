...
/**
 * A policy between two components of an architecture. Apart from the connection
 * itself, a policy has a type.
 * 
 * @author $Author: heinemann $
 * @version $Rev: 51068 $
 * @ConQAT.Rating GREEN Hash: E3A8BC6E0D86B52A472FE735170E0EFD
 */
