 ...
 * @version $Rev: 50143 $
 * @ConQAT.Rating GREEN Hash: 1131F5255E43FB2ADEEBB18876FE8726
 */
...
public class ArchitectureAnalyzer extends ConQATProcessorBase {
	...
	/** {@ConQAT.Doc} */
	@AConQATFieldParameter(parameter = "empty-dependencies-log-level", attribute = "value", optional = true, description = "Level on which empty dependencies are logged. Default is ERROR.")
	public ELogLevel emptyDependenciesLogLevel = ELogLevel.ERROR;
	...
	public AnnotatedArchitecture process() throws ConQATException {
		...
		if (assessor.getAllDependencies().isEmpty()) {
			getLogger().log(
					emptyDependenciesLogLevel,
					"No dependencies found in provided "
