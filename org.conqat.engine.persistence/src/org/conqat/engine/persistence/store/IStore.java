 ...
 * @version $Rev: 51583 $
 * @ConQAT.Rating GREEN Hash: 7BB0D4CA809545C0E2C568DEE8CE5120
 */
public interface IStore {
	...
	/** Removes all elements starting with the given prefix. */
	void removeByPrefix(byte[] prefix) throws StorageException;
