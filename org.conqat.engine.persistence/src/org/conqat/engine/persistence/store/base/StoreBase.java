 ...
 * @version $Rev: 51583 $
 * @ConQAT.Rating GREEN Hash: 11842242C779F59DB8DC85FF0439770F
 */
public abstract class StoreBase implements IStore {
	...
	/** Generates end key */
	protected byte[] generateEndKey(byte[] prefix) {
	...
	public void removeByPrefix(byte[] prefix) throws StorageException {
		remove(StorageUtils.listKeysStartingWith(prefix, this));
	}
}