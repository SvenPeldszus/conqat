 ...
 * @version $Rev: 50478 $
 * @ConQAT.Rating GREEN Hash: 19235635A2FD6C4F8A4E79860C39EB5C
 */
...
public class ScopeDifferencer extends
	...
	/** {@ConQAT.Doc} */
	@AConQATFieldParameter(parameter = "id-transformation", attribute = ConQATParamDoc.INPUT_REF_NAME, optional = true, description = ""
			+ "If this parameter is set, the transformation is applied to the id of the subtract nodes before matching nodes.")
	...
	protected void processInput(IRemovableConQATNode input) {
		...
		for (IRemovableConQATNode subtractElement : TraversalUtils
			...
			if (transformations != null) {
				subtractElementId = transformations
						.applyTransformation(subtractElementId);
			}
