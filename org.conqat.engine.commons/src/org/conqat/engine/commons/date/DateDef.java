 ...
 * @version $Rev: 51163 $
 * @ConQAT.Rating GREEN Hash: 5A344F5AAFD86D6BBE04E568959D9664
 */
@AConQATProcessor(description = "This processor creates Date objects. If called "
		...
		+ "Alternatively the date can be set via a date string or a timestamp. "
		+ "In addition, single fields of the date can be set in relative manner. "
		+ "For example, the date of one week ago can be created by setting no explicit "
		+ "date but setting the DAY_OF_YEAR field to -7 with the 'relative' parameter "
		+ "or to 7 with the 'negative-relative' parameter. See class java.util.Calendar "
...
public class DateDef extends ConQATProcessorBase {
	...
	/** {@ConQAT.Doc} */
	@AConQATParameter(name = "timestamp", minOccurrences = 0, maxOccurrences = 1, description = "Set date as timestamp. If not specified, "
			+ "the current date is used.")
	public void setTimestamp(
			@AConQATAttribute(name = "value", description = "timestamp") long timestamp) {
