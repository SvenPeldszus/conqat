...
+-------------------------------------------------------------------------*/
package org.conqat.engine.sourcecode.shallowparser.languages.plsql;

import static org.conqat.engine.sourcecode.shallowparser.languages.plsql.PlsqlShallowParser.EPlsqlParserStates.DECLARATIONS;
import static org.conqat.engine.sourcecode.shallowparser.languages.plsql.PlsqlShallowParser.EPlsqlParserStates.STATEMENTS;
 ...
 * @version $Rev: 51148 $
 * @ConQAT.Rating YELLOW Hash: 42448A134B0133E7E9D1149751E62743
 */
	...
	private void createStatementRules() {
		...
		inState(STATEMENTS)
				.sequence(LEFT_LABEL_BRACKET, PLSQL_IDENTIFIERS,
						RIGHT_LABEL_BRACKET)
				.createNode(EShallowEntityType.META, SubTypeNames.LABEL, 1)
				.endNode();
