...
+-------------------------------------------------------------------------*/
package org.conqat.engine.sourcecode.shallowparser.languages.ada;

import static org.conqat.engine.sourcecode.shallowparser.languages.ada.AdaShallowParser.EAdaParserStates.DECLARATIONS;
import static org.conqat.engine.sourcecode.shallowparser.languages.ada.AdaShallowParser.EAdaParserStates.STATEMENTS;
 ...
 * @version $Rev: 51222 $
 * @ConQAT.Rating GREEN Hash: 4BD72FECEE59933056ABCE1E7D20DAC2
 */
public class AdaShallowParser extends
	...
	private void createStatementRules() {
		...
		inState(STATEMENTS).sequence(IDENTIFIER, COLON)
				.sequenceBefore(EnumSet.of(WHILE, FOR, LOOP, BEGIN))
		...
		// goto labels as meta
		inState(STATEMENTS).sequence(LEFT_LABEL_BRACKET)
				.skipTo(RIGHT_LABEL_BRACKET)
