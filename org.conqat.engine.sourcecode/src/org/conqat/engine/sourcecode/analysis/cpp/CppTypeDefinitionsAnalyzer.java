 ...
 * @version $Rev: 47831 $
 * @ConQAT.Rating GREEN Hash: 0835B4F1E0286F41FB0140DD57532BBF
 */
...
public class CppTypeDefinitionsAnalyzer extends CppFindingAnalyzerBase {
	...
	/** The name of the findings group used. */
	public static final String FINDINGS_GROUP_NAME = "Multiple type definitions";
	...
	protected void analyzeShallowEntities(ITokenElement element,
		...
		if (toplevelClasses.size() > 1) {
			...
			if (!entity.getName().equals(getBaseName(element))
					&& !entity.getName().equals("<anonymous>")) {
