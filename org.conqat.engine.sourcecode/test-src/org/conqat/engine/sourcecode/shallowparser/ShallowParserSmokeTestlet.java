 ...
 * @version $Rev: 49567 $
 * @ConQAT.Rating GREEN Hash: F0AAA7E5A2A95D70606A886FA59B891F
 */
@Ignore
public class ShallowParserSmokeTestlet extends TestletBase {
	...
	public void test() throws IOException {
		...
		// compilable
		ShallowEntity incompleteEntity = ShallowEntityTraversalUtils
				.findIncompleteEntity(entities);
		assertNull("Found incomplete entity: " + incompleteEntity,
				incompleteEntity);
