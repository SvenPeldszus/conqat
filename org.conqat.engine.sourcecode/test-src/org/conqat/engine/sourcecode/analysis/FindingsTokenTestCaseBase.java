 ...
 * @version $Rev: 49552 $
 * @ConQAT.Rating GREEN Hash: 89E063246E936BB54A52899238506389
 */
public abstract class FindingsTokenTestCaseBase extends TokenTestCaseBase {
	...
	protected ITokenElement executeProcessor(String filename)
			throws ConQATException {
		return executeProcessor(filename, tokenLanguage);
	}

	/** Run processor on given file. */
	protected ITokenElement executeProcessor(String filename, ELanguage language)
			throws ConQATException {
