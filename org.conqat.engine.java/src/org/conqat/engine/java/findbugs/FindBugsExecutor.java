 ...
 * @version $Rev: 47940 $
 * @ConQAT.Rating GREEN Hash: 859B322FCA7DD0F4AED7F712435E98AC
 */
...
public class FindBugsExecutor extends JavaExecutorBase {
	...
	/** {@ConQAT.Doc} */
	@AConQATFieldParameter(parameter = "lenient", attribute = "mode", description = "If in lenient mode, missing files are ignored and logged. "
	...
	public String process() throws ConQATException {
		...
		if (context.hasMissingFiles()) {
			String message = "The following files were not found on the file system: "
					+ StringUtils.CR
